...
#define	RT_TIMER_FLAG_ONE_SHOT		0X0		/* 单词激活 */
#define	RT_TIMER_FLAG_PERIODIC		0X2		/* 周期定时 */

#define	RT_TIMER_FLAG_HARD_TIMER	0X0		/* 硬件定时器，定时器回调函数  */

#define	RT_TIMER_FLAG_SOFT_TIMER	0X4		/* 软件定时器，定时器回调函数再定时器线程中调用 */

#define RT_TIMER_CTRL_GET_TIME		0X1		/* 设置定时器时间 */
#define	RT_TIMER_CTRL_SET_TIME		0X0		/* 获取定时器时间 */
...
struct rt_timer
{
	...
	void (*timerout_func)(void *parameter);
	void 		*parameter;
